 ...
 */
$messages['it'] = array(
        'clipup-desc' => 'Permette di caricare file direttamente dagli appunti usando InlineAttachment',
        'clipup-notLoadConfig' => '[Clip_Upload:La configurazione non è stata caricata]',
        'clipup-progressText' => ':[Clip_Upload:Caricamento file …]()',
        'clipup-failduploadText' => ':[Clip_Upload:Caricamento fallito (%s)]',
        //please do not translate inside the flag%s. It will be replace some other text.
        'clipup-uploadingText' => ':[Clip_Upload:Caricamento in corso %s (%s KB) …]',
        'clipup-urlText' => ':[[File:%s]]',
        'clipup-notsamesize' => ':[Clip_Upload:Il file non è identito]',
        'clipup-istoolarge' => ':[Clip_Upload:Il file è troppo pesante: %s KB!]',
        'clipup-errdoingupload' => ':[Clip_Upload:Si è verificato un errore durante il caricamento]',
        'clipup-mwfeedbackerrorText' => '[Clip_Upload:Si è verificato un errore durante il caricamento (%s)]',
);